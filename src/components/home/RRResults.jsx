...
function RRResults({ results, extras, closeHandler }) {
                            ...
                            <div className='dropdown'>
                                ...
                                <div
                                    ...
                                    onClick={() => {
                                        ...
                                        const rows = [["PID", "AT", "BT", "ST", "FT", "TAT", "WT", "RT"], ...results.data.map(r => [r.pid, r.at, r.bt, r.st, r.ft, r.ft - r.at, r.ft - r.at - r.bt, r.st - r.at])];
